...
class Signup:
    def __init__(self, root):
        ...
        self.btn_female = Radiobutton(root, text="Female", padx=20, variable=self.gender, value='Female', bg="white",
                                      font=(5),
        ...
        conpass = Label(root, text="Conform Password", width=20, font=('goudy old style', 15, 'bold'), bg="white",
                        fg='black')
        ...
        btn_submit = Button(root, text='SUBMIT', width=8, bg='#078fc9', fg='white',
                            font=('goudy old style', 15, 'bold'), command=self.DB_Conactivity).place(
