...
L_to_Con = Label(splash_root, text="Welcome", font=("bold",50,), bg="lightgrey", fg='#078fc9').place(x=100, y=200)
...
def main():
    ...
    Button(root, text='Login', width=25, bg='#078fc9',fg='white',font=('goudy old style', 15,'bold'), command=login).place(x=100, y=230)
    signup_label = Label(root, text="Dont have an account ?", bg="lightgrey",font=('goudy old style', 15), fg="black").place(x=180,y=300)
    Button(root, text='Signup',width=25, bg='#078fc9',fg='white',font=('goudy old style', 15,'bold'), command=signup).place(x=100, y=330)
